...
const { getProceedSBB } = require("../utils/proceedSBB");
...
const SBB = async (refAcc, acc, pages, isSetupReady) => {
...
module.exports = { SBB, isAutoBettingObj };
