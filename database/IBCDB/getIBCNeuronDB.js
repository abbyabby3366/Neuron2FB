...
function getIBCNeuronDB() {
  ...
  fetch(url)
    ...
    .then((data) => {
      ...
      let IBCConfirmedArray = leagueNames.map((el) => el.leagueName);
      console.log("current IBC confirmed leagues: ", IBCConfirmedArray.length);

      fs.writeFile(
        "./IBCDB/output/IBCConfirmedLeagues.json",
