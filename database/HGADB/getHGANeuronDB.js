...
function getHGANeuronDB() {
  ...
  fetch(url)
    ...
    .then((data) => {
      ...
      let HGAConfirmedArray = leagueNames.map((el) => el.leagueName);
      console.log("current HGA confirmed leagues: ", HGAConfirmedArray.length);

      fs.writeFile(
        "./HGADB/output/HGAConfirmedLeagues.json",
