async function setupPage(page) {
  console.log("ISN - preparing to setup");
  // let status = false;
  ...
  //   //change to eu odds
  //   await page.evaluate(() => {
  //     const oddsChange = document.querySelector("#header > header > div.c-header__option > div.c-btn-group > div.c-dropdown.c-dropdown--Decimal > div.c-dropdown__btn");
  ...
  //   //click live markets
  //   await page.evaluate(() => {
  //     const element = document.querySelector('.c-side-nav__header[title="Sports"] ~ div.c-side-nav__tabs div.c-side-nav__tab[title="Live"]');
  ...
  //     document.querySelector("#mainArea > div > div.c-odds-page__header > div.c-odds-page__option > div.c-dropdown.c-dropdown--right > div.c-dropdown__btn").click()
  //     await new Promise(resolve => setTimeout(resolve, 200));
  ...
  //   await page.evaluate(async () => {
  //     while (true) {
  //       const handle = document.querySelector('div.myBets div.bet.rejected.live span.btn-content');
  //       if (!handle) break;
