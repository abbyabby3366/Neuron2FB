...
async function autoBetPS3838(page, betEvent, referenceAcc, successBetListKey) {
  ...
  try {
    ...
    // let ticketDataTarget = await ticketEventSBO(page, acc, betEvent, convertToEUString, closeTicket = false);
    ...
    let {
      ...
      vig: referenceVig, //should get this from brainv2
    ...
    let betEnteredTime = await placeBetPS3838(page, stake, acc);
    ...
    let bettedOdds = await waitBetPS3838(page, acc);
